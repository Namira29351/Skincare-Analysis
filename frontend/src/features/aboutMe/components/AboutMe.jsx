function AboutMe() {
    return (
        <div>
            <div>
            <h1 style={{ width: "56.5%", height:"60px", padding:"0px", float:"right", fontFamily:"initial"  }}>About Me</h1> 
            ...
            <div>
                <img
                src="https://images.unsplash.com/photo-1600428877878-1a0fd85beda8?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                alt="Skincare"
                style={{
                    width: "450px",
                    height: "auto",
